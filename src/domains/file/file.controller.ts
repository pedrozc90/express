...
import { FileUtils, toBigInt } from "../../shared/utils";
...
export const fetch = async (req: Request, res: Response) => {
    ...
    const fetched = await FileService.fetch(args);
...
export const upload = async (req: Request, res: Response) => {
    ...
    const sf = await FileService.create({
...
export const download = async (req: Request, res: Response) => {
    ...
    const sf = await FileService.get(id);

    const content = await FileService.getContent(id);
...
export const remove = async (req: Request, res: Response) => {
    const id = parseId(req);
    const sf = await FileService.remove(id);
